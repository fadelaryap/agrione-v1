...
import { Plus, Calendar, FileText, Save, Upload, GanttChart, Grid3x3, MapPin, Sparkles, Layers } from 'lucide-react'
              ...
              <div
                ...
                className={`bg-white rounded-lg shadow-lg p-6 border-2 transition-all hover:shadow-xl ${
                  field.hasActiveSeason 
                    ...
                    : 'border-gray-200 hover:border-[#2E4E2A] cursor-pointer'
                }`}
                onClick={() => {
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3 flex-1">
                    <MapPin className="w-6 h-6 flex-shrink-0" style={{ color: '#2E4E2A' }} />
                ...
                {field.hasActiveSeason ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <div className="px-4 py-2 text-white rounded-lg text-sm font-medium inline-block" style={{ backgroundColor: '#2E4E2A' }}>
                      Buat Perencanaan
                    </div>
                  </div>
                )}
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-end gap-2">
              <button
                ...
                className="px-4 py-2 rounded-lg transition-colors text-sm font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{ backgroundColor: 'rgba(46, 78, 42, 0.1)', color: '#2E4E2A' }}
                onMouseEnter={(e) => !e.currentTarget.disabled && (e.currentTarget.style.backgroundColor = 'rgba(46, 78, 42, 0.2)')}
                onMouseLeave={(e) => !e.currentTarget.disabled && (e.currentTarget.style.backgroundColor = 'rgba(46, 78, 42, 0.1)')}
              >
              ...
              {activities.length > 0 && (
                <>
                  ...
                  <button
                    onClick={onGenerate}
                    disabled={!plantingDate}
                    className="px-4 py-2 text-white rounded-lg transition-colors text-sm font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{ backgroundColor: '#2E4E2A' }}
            ...
            {activities.length > 0 && (
              <div className="flex items-center gap-2 bg-white rounded-lg p-1 border border-gray-200 ml-auto">
                <button
                  ...
                  style={viewMode === 'gantt' ? { backgroundColor: '#2E4E2A' } : {}}
                ...
                <button
                  ...
                  style={viewMode === 'card' ? { backgroundColor: '#2E4E2A' } : {}}
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-12 text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <button
                  onClick={onOpenTemplate}
                  disabled={!plantingDate}
                  className="px-4 py-2 text-white rounded-lg transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{ backgroundColor: '#2E4E2A' }}
                  onMouseEnter={(e) => !e.currentTarget.disabled && (e.currentTarget.style.opacity = '0.9')}
                  onMouseLeave={(e) => !e.currentTarget.disabled && (e.currentTarget.style.opacity = '1')}
                >
            ...
            <div className="grid grid-cols-1 gap-4">
              {templates.map((template) => (
                <button
                  ...
                  className="text-left p-4 border border-gray-200 rounded-lg hover:border-[#2E4E2A] transition-colors"
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(46, 78, 42, 0.05)'}
