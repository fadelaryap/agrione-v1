  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-2 mb-4">
        <h2 className="text-sm font-semibold text-gray-900">Inteligensi Lapangan</h2>
        <span className="text-xs text-gray-600">• Analitik Real-time dengan Wawasan AI</span>
      </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-900">Distribusi Fase Pertumbuhan</span>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-900">Pola Curah Hujan Mingguan</span>
            </div>
            <div className="flex items-center gap-1 text-xs text-green-600">
              <TrendingUp className="w-3 h-3" />
          ...
          <div className="h-32">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={rainfallData}>
                ...
                <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: '#6b7280' }} tickFormatter={(v) => `${v}mm`} />
                <Tooltip
                  contentStyle={{
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <div className="flex items-center gap-1 text-xs">
              <div className="w-4 h-0.5 border-dashed" style={{ borderTop: '2px dashed #9ca3af' }} />
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-900">Ikhtisar Kesehatan Kluster</span>
            </div>
          ...
          <div className="flex items-center justify-center gap-6 mt-2">
            ...
            <div className="flex items-center gap-1 text-xs">
              ...
              <span className="text-gray-600">Kesehatan Tanaman %</span>
            </div>
          </div>
