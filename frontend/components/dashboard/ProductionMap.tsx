  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-lg mb-6">
      <div className="flex items-start justify-between mb-3">
        <div>
          <span className="text-sm text-gray-700 font-medium">Peta Produktivitas Lahan</span>
          <p className="text-xs text-gray-600 mt-1">Arahkan mouse ke lahan untuk melihat detail</p>
        </div>
        <div className="p-2 rounded-lg transition-transform hover:scale-110" style={{ backgroundColor: 'rgba(46, 78, 42, 0.1)' }}>
          <MapPin className="w-4 h-4" style={{ color: '#2E4E2A' }} />
        </div>
      </div>

      <div className="relative bg-gradient-to-br from-emerald-900/20 to-green-800/30 rounded-xl overflow-hidden border border-gray-200">
        <svg
          viewBox="0 0 100 65"
        ...
        {hoveredPlot && (
          <div
            className="absolute z-10 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-lg p-3 shadow-xl pointer-events-none transform -translate-x-1/2 -translate-y-full"
            style={{
              left: tooltipPos.x,
              top: tooltipPos.y,
              minWidth: "180px",
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              />
              <span className="font-semibold text-gray-900">{hoveredPlot.name}</span>
            ...
            <div className="space-y-1.5 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{hoveredPlot.area} ha</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Produksi:</span>
                <span className="font-medium text-gray-900">{hoveredPlot.production.toFixed(1)} ton</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Produktivitas:</span>
                <span className="font-medium text-gray-900">{hoveredPlot.productivity} ton/ha</span>
              </div>
        ...
        {/* Legend */}
        <div className="absolute bottom-2 right-2 bg-white/90 backdrop-blur-sm rounded-lg p-2 border border-gray-200 shadow-lg">
          <p className="text-xs font-medium text-gray-900 mb-1.5">Produktivitas (ton/ha)</p>
        ...
        {/* Map controls hint */}
        <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm rounded-lg px-2 py-1 border border-gray-200 shadow-lg">
          <span className="text-xs text-gray-600">Total: 239.95 ha • 23 Blok</span>
        </div>
      </div>
    </div>
  );
