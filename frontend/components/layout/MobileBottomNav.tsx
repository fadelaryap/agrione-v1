...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-200 shadow-2xl z-50" style={{ position: 'fixed', bottom: 0, paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <div className="flex justify-around items-center h-20 px-2" style={{ minHeight: '80px', paddingBottom: 'env(safe-area-inset-bottom)' }}>
        {navItems.map((item) => {
